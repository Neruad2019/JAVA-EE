...
<div class="row justify-content-center mt-sm-4">
    ...
    <div class="col-md-5 ml-sm-4">
        <%
            ArrayList<Post> posts= DBManager.getFriendsPosts((int)(long)user.getId());
        ...
        <div class="card mt-sm-3">
            ...
            <div class="card-footer">
                <small class="text-muted">Posted on <%=String.valueOf(posts.get(i).getPost_date()).substring(0,16)%> by <%=posts.get(i).getAuthor_name()%></small>
            </div>
        </div>
        <%}%>
    </div>
